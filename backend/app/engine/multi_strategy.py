...
class MultiStrategy(BaseGridStrategy):
    """
    做多网格策略
    ...
    strategy_type = 'MULTI'
    parent_cell_type = 'BUY'
    child_cell_type = 'SELL'
    trade_side_primary = TradeSide.BUY
    trade_side_secondary = TradeSide.SELL
    primary_sort_asc = True     # 买入: 价格低优先
    secondary_sort_asc = False  # 卖出: 价格高优先
